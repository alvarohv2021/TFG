...
CREATE TABLE `fotos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `id_UNIQUE` (`id`),
  KEY `fk_idCasa_idx` (`Casa`),
  CONSTRAINT `fk_idCasa` FOREIGN KEY (`Casa`) REFERENCES `casas` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `fotos` VALUES (1,'[2]',NULL);
...
-- Dump completed on 2022-06-07 22:16:49
